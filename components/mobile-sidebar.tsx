...
const adminGroupHeaderClass = "px-2 py-1 mb-1 rounded bg-blue-50/60 dark:bg-blue-950/60 text-[11px] font-semibold uppercase tracking-wide text-blue-600 dark:text-blue-400";
          ...
          {Object.entries(adminNavItems.reduce((acc, item) => {
            ...
            <div key={group} className="mb-2">
              ...
              {groupIdx < arr.length - 1 && (
                <div className="my-2 border-t border-blue-100 dark:border-blue-900/40" />
              )}
            </div>
          ))}
        </div>
